...
Opal.modules["corelib/process/status"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $klass = Opal.klass, $def = Opal.def, $return_ivar = Opal.return_ivar, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $parent_nesting) {
    ...
    return (function($base, $super) {
      ...
      $def(self, '$exitstatus', $return_ivar("status"));
...
Opal.modules["nodejs/kernel"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $slice = Opal.slice, $extract_kwargs = Opal.extract_kwargs, $ensure_kwargs = Opal.ensure_kwargs, $hash_get = Opal.hash_get, $truthy = Opal.truthy, $eqeqeq = Opal.eqeqeq, $gvars = Opal.gvars, $neqeq = Opal.neqeq, $def = Opal.def, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    $def(self, '$system', function $$system($a, $b) {
      ...
      exception = $hash_get($kwargs, "exception");if (exception == null) exception = false;
      env = (new Map());
