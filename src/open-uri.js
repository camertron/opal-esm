...
Opal.modules["corelib/pack_unpack/format_string_parser"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["corelib/array/pack"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["open-uri"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $alias = Opal.alias, $slice = Opal.slice, $truthy = Opal.truthy, $send = Opal.send, $to_a = Opal.to_a, $def = Opal.def, $defs = Opal.defs, $eqeq = Opal.eqeq, $klass = Opal.klass, $send2 = Opal.send2, $find_super = Opal.find_super, $rb_plus = Opal.rb_plus, $eqeqeq = Opal.eqeqeq, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;
  ...
  return (function($base, $parent_nesting) {
    ...
    $defs(self, '$open_uri', function $$open_uri(name, $a) {
      ...
      $post_args = $slice(arguments, 1);
      rest = $post_args;
      io = self.$open_loop(name, (new Map()));
      io.$rewind();
      if (($yield !== nil)) {
    ...
    (function($base, $parent_nesting) {
      ...
      $defs($$('Meta'), '$init', function $$init(obj, src) {
        ...
        $send(obj, 'instance_eval', [], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;
          ...
          self.base_uri = nil;
          self.meta = (new Map());
          return (self.metas = (new Map()));}, {$$s: self});
        if ($truthy(src)) {
