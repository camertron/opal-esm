...
Opal.modules["base64"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $defs = Opal.defs, $ensure_kwargs = Opal.ensure_kwargs, $hash_get = Opal.hash_get, $truthy = Opal.truthy, $nesting = [], nil = Opal.nil;
  ...
  ;
    ...
    return $defs(self, '$urlsafe_encode64', function $$urlsafe_encode64(string, $kwargs) {
      ...
      padding = $hash_get($kwargs, "padding");if (padding == null) padding = true;
...
Opal.modules["opal/source_map/map"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal/source_map/file"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal/source_map/index"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal/source_map/vlq"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal/source_map"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal-source-maps"] = function(Opal) {/* Generated by Opal 1.8.2 */
