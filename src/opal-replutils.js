...
Opal.modules["thread"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $defs = Opal.defs, $slice = Opal.slice, $def = Opal.def, $send = Opal.send, $Opal = Opal.Opal, $alias = Opal.alias, $return_ivar = Opal.return_ivar, $const_set = Opal.const_set, $assign_ivar_val = Opal.assign_ivar_val, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$core_initialize!', function $Thread_core_initialize$excl$5() {
      ...
      self.thread_locals = (new Map());
      return (self.fiber_locals = (new Map()));
    });
...
Opal.modules["prettyprint"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$fill_breakable', function $$fill_breakable(sep, width) {
      ...
      return $send(self, 'group', [], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;
        ...
        return self.$breakable(sep, width)}, {$$s: self});
    }, -1);
    ...
    $def(self, '$group', function $$group(indent, open_obj, close_obj, open_width, close_width) {
      ...
      $send(self, 'group_sub', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;
        ...
        return $send(self, 'nest', [indent], function $$5(){
          return Opal.yieldX($yield, []);})}, {$$s: self});
    ...
    $def(self, '$flush', function $$flush() {
      ...
      $send(self.buffer, 'each', [], function $$6(data){var self = $$6.$$s == null ? this : $$6.$$s;
        ...
        return (self.output_width = data.$output(self.output, self.output_width));}, {$$s: self});
      self.buffer.$clear();
      return (self.buffer_width = 0);
    });
    (function($base, $super) {
    ...
    (function($base, $super) {
      ...
      $def(self, '$break', $assign_ivar_val("break", true));
      
      $def(self, '$break?', $return_ivar("break"));
        ...
        $send(self.queue, 'each', [], function $$10(gs){
          ...
          $send($rb_minus(gs.$length(), 1), 'downto', [0], function $$11(i){var group = nil;
            ...
            if ($truthy(gs['$[]'](i).$breakables()['$empty?']())) {
              ...
              group.$break();
              $t_return.$throw(group, $$11.$$is_lambda);
            };}, {$$ret: $t_return});
...
Opal.modules["pp"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $gvars = Opal.gvars, $send = Opal.send, $defs = Opal.defs, $slice = Opal.slice, $to_a = Opal.to_a, $module = Opal.module, $eqeq = Opal.eqeq, $def = Opal.def, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $eqeqeq = Opal.eqeqeq, $neqeq = Opal.neqeq, $not = Opal.not, $rb_gt = Opal.rb_gt, $rb_le = Opal.rb_le, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      $def(self, '$guard_inspect_key', function $$guard_inspect_key() {
        ...
        $$guard_inspect_key.$$p = null;
        
        if ($eqeq($$('Thread').$current()['$[]']("__recursive_key__"), nil)) {
          $$('Thread').$current()['$[]=']("__recursive_key__", (new Map()).$compare_by_identity())
        };
        if ($eqeq($$('Thread').$current()['$[]']("__recursive_key__")['$[]']("inspect"), nil)) {
          $$('Thread').$current()['$[]']("__recursive_key__")['$[]=']("inspect", (new Map()).$compare_by_identity())
        };
      ...
      ;
        ...
        if ($truthy(self.$check_inspect_key(obj))) {
          ...
          $send(self, 'group', [], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;
            ...
            return obj.$pretty_print_cycle(self)}, {$$s: self});
          return nil;
        };
        ...
        return $send(self, 'group', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;
          ...
          return obj.$pretty_print(self)}, {$$s: self});
        } finally {
      ...
      $def(self, '$seplist', function $$seplist(list, sep, iter_method) {
        ...
        sep = ($truthy(($ret_or_1 = sep)) ? ($ret_or_1) : ($send(self, 'lambda', [], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
          ...
          return self.$comma_breakable()}, {$$s: self})));
        first = true;
      ...
      $def(self, '$pp_object', function $$pp_object(obj) {
        ...
        return $send(self, 'object_address_group', [obj], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;
          ...
          return $send(self, 'seplist', [obj.$pretty_print_instance_variables(), $send(self, 'lambda', [], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;
            ...
            return self.$text(",")}, {$$s: self})], function $$9(v){var self = $$9.$$s == null ? this : $$9.$$s;
            ...
            return $send(self, 'group', [1], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;
              ...
              self.$breakable("");
              return self.$pp(obj.$instance_eval(v));}, {$$s: self});}, {$$s: self})}, {$$s: self})
      });
          ...
          return $send(self, 'seplist', [obj, nil, "each_pair"], function $$12(k, v){var self = $$12.$$s == null ? this : $$12.$$s;
            ...
            return $send(self, 'group', [], function $$13(){var self = $$13.$$s == null ? this : $$13.$$s;
              ...
              return $send(self, 'group', [1], function $$14(){var self = $$14.$$s == null ? this : $$14.$$s;
                ...
                self.$breakable("");
                return self.$pp(v);}, {$$s: self});}, {$$s: self});}, {$$s: self})}, {$$s: self})
      });
    })($nesting[0], $nesting);
  ...
  (function(self, $parent_nesting) {
    ...
    return $def(self, '$pretty_print', function $$pretty_print(q) {
      ...
      $send($$('ENV').$keys().$sort(), 'each', [], function $$18(k){var $a;
        ...
        if (k == null) k = nil;
        return ($a = [k, $$('ENV')['$[]'](k)], $send(h, '[]=', $a), $a[$a.length - 1]);});
      return q.$pp_hash(h);
    })
    ...
    $def(self, '$pretty_print', function $$pretty_print(q) {
      ...
      return $send(q, 'group', [1, self.$sprintf("#<struct %s", $$('PP').$mcall(self, $$('Kernel'), "class").$name()), ">"], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s;
        ...
        return $send(q, 'seplist', [$$('PP').$mcall(self, $$('Struct'), "members"), $send(self, 'lambda', [], function $$20(){
          return q.$text(",")})], function $$21(member){var self = $$21.$$s == null ? this : $$21.$$s;
          ...
          return $send(q, 'group', [1], function $$22(){var self = $$22.$$s == null ? this : $$22.$$s;
            ...
            q.$breakable("");
            return q.$pp(self['$[]'](member));}, {$$s: self});}, {$$s: self})}, {$$s: self})
    });
    return $def(self, '$pretty_print_cycle', function $$pretty_print_cycle(q) {
      var self = this;
      ...
      if ($truthy($rb_gt(lines.$size(), 1))) {
        return $send(q, 'group', [0, "", ""], function $$23(){var self = $$23.$$s == null ? this : $$23.$$s;
          ...
          return $send(q, 'seplist', [lines, $send(self, 'lambda', [], function $$24(){
            ...
            q.$text(" +");
            return q.$breakable();})], function $$25(v){
    ...
    return $def(self, '$pretty_print', function $$pretty_print(q) {
      ...
      $send(self.$regexp().$named_captures(), 'each', [], function $$26(name, indexes){
        ...
        return $send(indexes, 'each', [], function $$27(i){var $a;
          ...
          if (i == null) i = nil;
          return ($a = [i, name], $send(nc, '[]=', $a), $a[$a.length - 1]);});});
      return $send(q, 'object_group', [self], function $$28(){var self = $$28.$$s == null ? this : $$28.$$s;
        ...
        return $send(q, 'seplist', [Opal.Range.$new(0,self.$size(), true), $send(self, 'lambda', [], function $$29(){
          return q.$breakable()})], function $$30(i){var self = $$30.$$s == null ? this : $$30.$$s;
...
Opal.modules["opal-replutils"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $truthy = Opal.truthy, $lambda = Opal.lambda, $rb_plus = Opal.rb_plus, $send = Opal.send, $rb_minus = Opal.rb_minus, $def = Opal.def, $klass = Opal.klass, $const_set = Opal.const_set, $defs = Opal.defs, $gvars = Opal.gvars, $send2 = Opal.send2, $find_super = Opal.find_super, $slice = Opal.slice, $to_a = Opal.to_a, $regexp = Opal.regexp, $eqeqeq = Opal.eqeqeq, self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('require,module_function,methods,ancestors,class,instance_variables,include?,instance_methods,constants,class_variables,empty?,+,[],join,sort,map,each,&,-,name,default,colorize,inspect,pp,ls,call,full_message,gets,parse,eval_and_print,puts,[]=,new,string,guard_inspect_key,flush,<<,length,dig,scan,to_proc,tokenize,===,=~,token');
  ...
  return (function($base, $parent_nesting) {
    ...
    $def(self, '$ls', function $$ls(object, colorize) {
      var methods = nil, imethods = nil, ancestors = nil, constants = nil, ivs = nil, cvs = nil, blue = nil, dark_blue = nil, out = nil;
      ...
      cvs = [];
      if ($truthy([$$('Class'), $$('Module')]['$include?'](object.$class()))) {
      ...
      if ($truthy(colorize)) {
        ...
        blue = $lambda(function $$1(i){
          
          if (i == null) i = nil;
          return "\u001b[1;34m" + (i) + "\u001b[0m";});
        dark_blue = $lambda(function $$2(i){
          
          if (i == null) i = nil;
          return "\u001b[34m" + (i) + "\u001b[0m";});
      } else {
        blue = (dark_blue = $lambda(function $$3(i){
      ...
      out = "";
      if (!$truthy(cvs['$empty?']())) {
        out = $rb_plus("" + (blue['$[]']("class variables")) + ": " + ($send(cvs, 'map', [], function $$4(i){
          
          if (i == null) i = nil;
          return dark_blue['$[]'](i);}).$sort().$join("  ")) + "\n", out)
      };
      if (!$truthy(ivs['$empty?']())) {
        out = $rb_plus("" + (blue['$[]']("instance variables")) + ": " + ($send(ivs, 'map', [], function $$5(i){
          
          if (i == null) i = nil;
          return dark_blue['$[]'](i);}).$sort().$join("  ")) + "\n", out)
      };
      $send(ancestors, 'each', [], function $$6(a){var im = nil, meths = nil;

        
        if (a == null) a = nil;
        im = a.$instance_methods(false);
        meths = im['$&'](imethods);
        methods = $rb_minus(methods, meths);
        imethods = $rb_minus(imethods, meths);
        if (($truthy(meths['$empty?']()) || ($truthy([$$('Object'), $$('BasicObject'), $$('Kernel'), $$$($$('PP'), 'ObjectMixin')]['$include?'](a))))) {
          return nil
        };
        return (out = $rb_plus("" + (blue['$[]']("" + (a.$name()) + "#methods")) + ": " + (meths.$sort().$join("  ")) + "\n", out));});
      methods = methods['$&'](object.$methods(false));
      if (!$truthy(methods['$empty?']())) {
        out = $rb_plus("" + (blue['$[]']("self.methods")) + ": " + (methods.$sort().$join("  ")) + "\n", out)
      };
      if (!$truthy(constants['$empty?']())) {
        out = $rb_plus("" + (blue['$[]']("constants")) + ": " + ($send(constants, 'map', [], function $$7(i){
    ...
    $def(self, '$eval_and_print', function $$eval_and_print(func, mode, colorize, binding) {
      var self = this, printer = nil, e = nil;

      
      if (binding == null) binding = nil;
      try {
        
        printer = ($truthy(colorize) ? ($lambda(function $$8(i){var e = nil;

          
          if (i == null) i = nil;
          try {
            return $$('ColorPrinter').$default(i)
          } catch ($err) {
            if (Opal.rescue($err, [$$('StandardError')])) {(e = $err)
              try {
                return $$('ColorPrinter').$colorize($$('Opal').$inspect(i))
              } finally { Opal.pop_exception($err); }
            } else { throw $err; }
          };})) : ($lambda(function $$9(i){var out = nil;
      ...
      if ($_result === null) {
        ...
        if (mode == 'ls') {
          return self.$ls($_result, colorize);
        }
        else {
    ...
    ;
        ...
        if (Opal.rescue($err, [$$('Exception')])) {(e = $err)
          try {
            return e.$full_message((new Map([["highlight", true]])))
          } finally { Opal.pop_exception($err); }
        } else { throw $err; }
      };
    }, -4);
    
    $def(self, '$js_repl', function $$js_repl() {
      var self = this, line = nil, input = nil, out = nil;

      while ($truthy((line = self.$gets()))) {
      
        input = $$('JSON').$parse(line);
        out = self.$eval_and_print(input['$[]']("code"), input['$[]']("mode"), input['$[]']("colors"));
        if ($truthy(out)) {
          self.$puts(out)
        };
        self.$puts("<<<ready>>>");
    ...
    return (function($base, $super, $parent_nesting) {
      var self = $klass($base, $super, 'ColorPrinter');

      var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting);

      
      $const_set($nesting[0], 'TOKEN_COLORS', (new Map([["debug", "\u001b[1;37;44m"], ["annotation", "\u001b[34m"], ["attribute_name", "\u001b[35m"], ["attribute_value", "\u001b[31m"], ["binary", (new Map([["self", "\u001b[31m"], ["char", "\u001b[1;31m"], ["delimiter", "\u001b[1;31m"]]))], ["char", (new Map([["self", "\u001b[35m"], ["delimiter", "\u001b[1;35m"]]))], ["class", "\u001b[1;35;4m"], ["class_variable", "\u001b[36m"], ["color", "\u001b[32m"], ["comment", (new Map([["self", "\u001b[1;30m"], ["char", "\u001b[37m"], ["delimiter", "\u001b[37m"]]))], ["constant", "\u001b[1;34;4m"], ["decorator", "\u001b[35m"], ["definition", "\u001b[1;33m"], ["directive", "\u001b[33m"], ["docstring", "\u001b[31m"], ["doctype", "\u001b[1;34m"], ["done", "\u001b[1;30;2m"], ["entity", "\u001b[31m"], ["error", "\u001b[1;37;41m"], ["exception", "\u001b[1;31m"], ["float", "\u001b[1;35m"], ["function", "\u001b[1;34m"], ["global_variable", "\u001b[1;32m"], ["hex", "\u001b[1;36m"], ["id", "\u001b[1;34m"], ["include", "\u001b[31m"], ["integer", "\u001b[1;34m"], ["imaginary", "\u001b[1;34m"], ["important", "\u001b[1;31m"], ["key", (new Map([["self", "\u001b[35m"], ["char", "\u001b[1;35m"], ["delimiter", "\u001b[1;35m"]]))], ["keyword", "\u001b[32m"], ["label", "\u001b[1;33m"], ["local_variable", "\u001b[33m"], ["namespace", "\u001b[1;35m"], ["octal", "\u001b[1;34m"], ["predefined", "\u001b[36m"], ["predefined_constant", "\u001b[1;36m"], ["predefined_type", "\u001b[1;32m"], ["preprocessor", "\u001b[1;36m"], ["pseudo_class", "\u001b[1;34m"], ["regexp", (new Map([["self", "\u001b[35m"], ["delimiter", "\u001b[1;35m"], ["modifier", "\u001b[35m"], ["char", "\u001b[1;35m"]]))], ["reserved", "\u001b[32m"], ["shell", (new Map([["self", "\u001b[33m"], ["char", "\u001b[1;33m"], ["delimiter", "\u001b[1;33m"], ["escape", "\u001b[1;33m"]]))], ["string", (new Map([["self", "\u001b[31m"], ["modifier", "\u001b[1;31m"], ["char", "\u001b[1;35m"], ["delimiter", "\u001b[1;31m"], ["escape", "\u001b[1;31m"]]))], ["symbol", (new Map([["self", "\u001b[33m"], ["delimiter", "\u001b[1;33m"]]))], ["tag", "\u001b[32m"], ["type", "\u001b[1;34m"], ["value", "\u001b[36m"], ["variable", "\u001b[34m"], ["insert", (new Map([["self", "\u001b[42m"], ["insert", "\u001b[1;32;42m"], ["eyecatcher", "\u001b[102m"]]))], ["delete", (new Map([["self", "\u001b[41m"], ["delete", "\u001b[1;31;41m"], ["eyecatcher", "\u001b[101m"]]))], ["change", (new Map([["self", "\u001b[44m"], ["change", "\u001b[37;44m"]]))], ["head", (new Map([["self", "\u001b[45m"], ["filename", "\u001b[37;45m"]]))], ["reset", "\u001b[0m"]])));
      $$('TOKEN_COLORS')['$[]=']("keyword", $$('TOKEN_COLORS')['$[]']("reserved"));
      $$('TOKEN_COLORS')['$[]=']("method", $$('TOKEN_COLORS')['$[]']("function"));
      $$('TOKEN_COLORS')['$[]=']("escape", $$('TOKEN_COLORS')['$[]']("delimiter"));
      $defs(self, '$default', function $ColorPrinter_default$10(obj, width) {
        var self = this, pager = nil;

        
        if (width == null) width = 79;
        pager = $$('StringIO').$new();
        self.$pp(obj, pager, width);
        return pager.$string();
      }, -2);
      $defs(self, '$pp', function $$pp(obj, output, max_width) {
        var queue = nil;
        if ($gvars.DEFAULT_OUTPUT == null) $gvars.DEFAULT_OUTPUT = nil;

        
        if (output == null) output = $gvars.DEFAULT_OUTPUT;
        if (max_width == null) max_width = 79;
        queue = $$('ColorPrinter').$new(output, max_width, "\n");
        $send(queue, 'guard_inspect_key', [], function $$11(){
          return queue.$pp(obj)});
        queue.$flush();
        return output['$<<']("\n");
      }, -2);
      
      $def(self, '$text', function $$text(str, max_width) {
        var $yield = $$text.$$p || nil, self = this;

        $$text.$$p = null;
        
        if (max_width == null) max_width = str.$length();
        return $send2(self, $find_super(self, 'text', $$text, false, true), 'text', [$$('ColorPrinter').$colorize(str), max_width], null);
      }, -2);
      $defs(self, '$token', function $$token(string, $a) {
        var $post_args, name;

        
        $post_args = $slice(arguments, 1);
        name = $post_args;
        return $rb_plus($rb_plus($send($$('TOKEN_COLORS'), 'dig', $to_a(name)), string), $$('TOKEN_COLORS')['$[]']("reset"));
      }, -2);
      $const_set($nesting[0], 'NUMBER', "[+-]?(?:0x[0-9a-fA-F]+|[0-9.]+(?:e[+-][0-9]+|i)?)");
      $const_set($nesting[0], 'REGEXP', "/.*?/[iesu]*");
      $const_set($nesting[0], 'STRING', "\".*?\"");
      $const_set($nesting[0], 'TOKEN_REGEXP', $regexp(["(\\s+|=>|[@$:]?[a-z]\\w+|[A-Z]\\w+|", $$('NUMBER'), "|", $$('REGEXP'), "|", $$('STRING'), "|#<.*?[> ]|.)"]));
      $defs(self, '$tokenize', function $$tokenize(str) {
        
        return $send(str.$scan($$('TOKEN_REGEXP')), 'map', [], "first".$to_proc())
      });
      return $defs(self, '$colorize', function $$colorize(str) {
        var self = this, tokens = nil;

        
        tokens = self.$tokenize(str);
        return $send(tokens, 'map', [], function $$12(tok){var self = $$12.$$s == null ? this : $$12.$$s, $ret_or_1 = nil;

          
          if (tok == null) tok = nil;
          if ($eqeqeq(/^[0-9+-]/, ($ret_or_1 = tok))) {
            if ($truthy(/[.e]/['$=~'](tok))) {
              return self.$token(tok, "float")
            } else {
              return self.$token(tok, "integer")
            }
          } else if ($eqeqeq(/^"/, $ret_or_1)) {
            return self.$token(tok, "string", "self")
          } else if ($eqeqeq(/^:/, $ret_or_1)) {
            return self.$token(tok, "symbol", "self")
          } else if ($eqeqeq(/^[A-Z]/, $ret_or_1)) {
            return self.$token(tok, "constant")
          } else if (($eqeqeq("<", $ret_or_1) || (($eqeqeq("#", $ret_or_1) || (($eqeqeq(/^#</, $ret_or_1) || (($eqeqeq("=", $ret_or_1) || ($eqeqeq(">", $ret_or_1)))))))))) {
            return self.$token(tok, "keyword")
          } else if ($eqeqeq(/^\/./, $ret_or_1)) {
            return self.$token(tok, "regexp", "self")
          } else if (($eqeqeq("true", $ret_or_1) || (($eqeqeq("false", $ret_or_1) || ($eqeqeq("nil", $ret_or_1)))))) {
            return self.$token(tok, "predefined_constant")
          } else {
            return self.$token(tok, "reset")
          };}, {$$s: self}).$join();
      });
    })($nesting[0], $$$('PP'), $nesting);
  })($nesting[0], $nesting);
};
